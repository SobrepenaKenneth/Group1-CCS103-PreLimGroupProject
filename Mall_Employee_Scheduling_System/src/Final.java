...
public class Final {
	...
	public static void displaySchedule() {
		...
		for (int day = 0; day < mallSchedule.length; day++) {
			...
			// This determines how many stacked rows we need to print
			// ------------------------------------------------------------
		...
		for (int day = 0; day < mallSchedule.length; day++) {
			...
			// Display total with bullet point
	 ...
	 * Steps: 1. Validate and get day from user 2. Validate and get shift from user
	 ...
	 * day is entered.
	 * 
	 * @return int Index corresponding to selected day (0-5)
	 */
	 ...
	 * 
	 * @return int Index corresponding to selected shift (0-2)
	 */
	 ...
	 * 
	 * Searches for an employee by ID or name and displays: - Employee details
	 * (name, role) - Current schedule (which days and shifts they work) - Total
	 * working hours (based on shift lengths: M=4h, A=2h, E=6h)
	 */
	public static void searchEmployee() {
		...
		boolean hasSchedule = false; // Flag to track if employee has any assignments
	 ...
	 * UPDATE/REMOVE SUBMENU
	 * 
	 * Displays submenu for update and remove operations: [1] Update Employee -
	 * Modify employee name/role [2] Remove Employee - Delete employee from schedule
	 */
	 ...
	 * EXIT METHOD
	 * 
	 * Handles program termination with confirmation. Asks user to confirm exit
	...
	public static void exit() {
		...
		while (true) {
			...
			switch (exitInput) {
			case "Y":
				// User confirmed - display goodbye message and exit
				System.out.println("\nThank you for using the Mall Employee Scheduling System!");
				System.out.println("Program Terminated");
				System.exit(0); // Terminate JVM
				break; // Not reached, but good practice

			case "N":
				// User changed mind - return to menu
				System.out.println();
